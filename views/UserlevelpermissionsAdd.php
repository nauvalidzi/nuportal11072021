...
<input type="<?= $Page->userlevelid->getInputTextType() ?>" data-table="userlevelpermissions" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" maxlength="11" value="<?= $Page->userlevelid->EditValue ?>"<?= $Page->userlevelid->editAttributes() ?> aria-describedby="x_userlevelid_help">
...
<input type="<?= $Page->_tablename->getInputTextType() ?>" data-table="userlevelpermissions" data-field="x__tablename" name="x__tablename" id="x__tablename" size="30" maxlength="80" value="<?= $Page->_tablename->EditValue ?>"<?= $Page->_tablename->editAttributes() ?> aria-describedby="x__tablename_help">
...
<input type="<?= $Page->_permission->getInputTextType() ?>" data-table="userlevelpermissions" data-field="x__permission" name="x__permission" id="x__permission" size="30" maxlength="11" value="<?= $Page->_permission->EditValue ?>"<?= $Page->_permission->editAttributes() ?> aria-describedby="x__permission_help">
