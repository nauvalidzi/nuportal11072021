...
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fberitaadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fberitaadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fberitaadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fberitaadd" id="fberitaadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
