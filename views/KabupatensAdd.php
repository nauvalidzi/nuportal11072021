...
loadjs.ready("head", function () {
    ...
    fkabupatensadd = currentForm = new ew.Form("fkabupatensadd", "add");
    ...
    // Validate form
    fkabupatensadd.validate = function () {
    ...
    // Form_CustomValidate
    fkabupatensadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkabupatensadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fkabupatensadd.lists.provinsi_id = <?= $Page->provinsi_id->toClientList($Page) ?>;
    loadjs.done("fkabupatensadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkabupatensadd" id="fkabupatensadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
