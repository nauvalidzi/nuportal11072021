...
// Page object
$PendidikanumumEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpendidikanumumedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fpendidikanumumedit = currentForm = new ew.Form("fpendidikanumumedit", "edit");
    ...
    // Validate form
    fpendidikanumumedit.validate = function () {
    ...
    // Form_CustomValidate
    fpendidikanumumedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpendidikanumumedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpendidikanumumedit.lists.idjenispu = <?= $Page->idjenispu->toClientList($Page) ?>;
    loadjs.done("fpendidikanumumedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpendidikanumumedit" id="fpendidikanumumedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpendidikanumumedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpendidikanumumedit", "x_tglberdiri", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpendidikanumumedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpendidikanumumedit", "x_ijinakhir", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php } ?>
    ...
    <input type="hidden" data-table="pendidikanumum" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
