...
// Page object
$JenispendidikanpesantrenEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fjenispendidikanpesantrenedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fjenispendidikanpesantrenedit = currentForm = new ew.Form("fjenispendidikanpesantrenedit", "edit");
    ...
    // Validate form
    fjenispendidikanpesantrenedit.validate = function () {
    ...
    // Form_CustomValidate
    fjenispendidikanpesantrenedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fjenispendidikanpesantrenedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fjenispendidikanpesantrenedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fjenispendidikanpesantrenedit" id="fjenispendidikanpesantrenedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="jenispendidikanpesantren" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
