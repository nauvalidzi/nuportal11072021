...
<input type="<?= $Page->userlevelname->getInputTextType() ?>" data-table="userlevels" data-field="x_userlevelname" name="x_userlevelname" id="x_userlevelname" size="30" maxlength="80" value="<?= $Page->userlevelname->EditValue ?>"<?= $Page->userlevelname->editAttributes() ?> aria-describedby="x_userlevelname_help">
