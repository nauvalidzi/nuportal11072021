...
// Page object
$FasilitaspesantrenEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var ffasilitaspesantrenedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    ffasilitaspesantrenedit = currentForm = new ew.Form("ffasilitaspesantrenedit", "edit");
    ...
    ffasilitaspesantrenedit.addFields([
    ...
    // Validate form
    ffasilitaspesantrenedit.validate = function () {
    ...
    // Form_CustomValidate
    ffasilitaspesantrenedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ffasilitaspesantrenedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ffasilitaspesantrenedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ffasilitaspesantrenedit" id="ffasilitaspesantrenedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_fasilitaspesantren_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_fasilitaspesantren_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="fasilitaspesantren" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" name="fa_x_fotofasilitas" id= "fa_x_fotofasilitas" value="<?= (Post("fa_x_fotofasilitas") == "0") ? "0" : "1" ?>">
