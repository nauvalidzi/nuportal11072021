...
// Page object
$JenispendidikanumumAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fjenispendidikanumumadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fjenispendidikanumumadd = currentForm = new ew.Form("fjenispendidikanumumadd", "add");
    ...
    // Validate form
    fjenispendidikanumumadd.validate = function () {
    ...
    // Form_CustomValidate
    fjenispendidikanumumadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fjenispendidikanumumadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fjenispendidikanumumadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fjenispendidikanumumadd" id="fjenispendidikanumumadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
