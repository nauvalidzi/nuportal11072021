...
loadjs.ready("head", function () {
    ...
    fkecamatansadd = currentForm = new ew.Form("fkecamatansadd", "add");
    ...
    // Validate form
    fkecamatansadd.validate = function () {
    ...
    // Form_CustomValidate
    fkecamatansadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkecamatansadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fkecamatansadd.lists.kabupaten_id = <?= $Page->kabupaten_id->toClientList($Page) ?>;
    loadjs.done("fkecamatansadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkecamatansadd" id="fkecamatansadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
