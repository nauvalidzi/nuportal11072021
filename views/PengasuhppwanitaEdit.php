...
// Page object
$PengasuhppwanitaEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpengasuhppwanitaedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fpengasuhppwanitaedit = currentForm = new ew.Form("fpengasuhppwanitaedit", "edit");
    ...
    fpengasuhppwanitaedit.addFields([
    ...
    // Validate form
    fpengasuhppwanitaedit.validate = function () {
    ...
    // Form_CustomValidate
    fpengasuhppwanitaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpengasuhppwanitaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpengasuhppwanitaedit.lists.pid = <?= $Page->pid->toClientList($Page) ?>;
    loadjs.done("fpengasuhppwanitaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpengasuhppwanitaedit" id="fpengasuhppwanitaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_pengasuhppwanita_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_pengasuhppwanita_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="pengasuhppwanita" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->pid->Visible) { // pid ?>
    <div id="r_pid" class="form-group row">
        <label id="elh_pengasuhppwanita_pid" class="<?= $Page->LeftColumnClass ?>"><?= $Page->pid->caption() ?><?= $Page->pid->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->pid->cellAttributes() ?>>
<?php if ($Page->pid->getSessionValue() != "") { ?>
<span id="el_pengasuhppwanita_pid">
...
<input type="hidden" is="selection-list" class="form-control" data-table="pengasuhppwanita" data-field="x_pid" data-input="sv_x_pid" data-value-separator="<?= $Page->pid->displayValueSeparatorAttribute() ?>" name="x_pid" id="x_pid" value="<?= HtmlEncode($Page->pid->CurrentValue) ?>"<?= $onchange ?>>
<?= $Page->pid->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->pid->getErrorMessage() ?></div>
<script>
loadjs.ready(["fpengasuhppwanitaedit"], function() {
    fpengasuhppwanitaedit.createAutoSuggest(Object.assign({"id":"x_pid","forceSelect":false}, ew.vars.tables.pengasuhppwanita.fields.pid.autoSuggestOptions));
});
</script>
...
<?php if ($Page->nama->Visible) { // nama ?>
    <div id="r_nama" class="form-group row">
        <label id="elh_pengasuhppwanita_nama" for="x_nama" class="<?= $Page->LeftColumnClass ?>"><?= $Page->nama->caption() ?><?= $Page->nama->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->nama->cellAttributes() ?>>
<span id="el_pengasuhppwanita_nama">
<input type="<?= $Page->nama->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_nama" name="x_nama" id="x_nama" size="30" maxlength="255" value="<?= $Page->nama->EditValue ?>"<?= $Page->nama->editAttributes() ?> aria-describedby="x_nama_help">
...
<?php if ($Page->nik->Visible) { // nik ?>
    <div id="r_nik" class="form-group row">
        <label id="elh_pengasuhppwanita_nik" for="x_nik" class="<?= $Page->LeftColumnClass ?>"><?= $Page->nik->caption() ?><?= $Page->nik->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->nik->cellAttributes() ?>>
<span id="el_pengasuhppwanita_nik">
<input type="<?= $Page->nik->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_nik" name="x_nik" id="x_nik" size="30" maxlength="255" value="<?= $Page->nik->EditValue ?>"<?= $Page->nik->editAttributes() ?> aria-describedby="x_nik_help">
...
<?php if ($Page->alamat->Visible) { // alamat ?>
    <div id="r_alamat" class="form-group row">
        <label id="elh_pengasuhppwanita_alamat" for="x_alamat" class="<?= $Page->LeftColumnClass ?>"><?= $Page->alamat->caption() ?><?= $Page->alamat->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->alamat->cellAttributes() ?>>
<span id="el_pengasuhppwanita_alamat">
<input type="<?= $Page->alamat->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_alamat" name="x_alamat" id="x_alamat" size="30" maxlength="255" value="<?= $Page->alamat->EditValue ?>"<?= $Page->alamat->editAttributes() ?> aria-describedby="x_alamat_help">
...
<?php if ($Page->hp->Visible) { // hp ?>
    <div id="r_hp" class="form-group row">
        <label id="elh_pengasuhppwanita_hp" for="x_hp" class="<?= $Page->LeftColumnClass ?>"><?= $Page->hp->caption() ?><?= $Page->hp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->hp->cellAttributes() ?>>
<span id="el_pengasuhppwanita_hp">
<input type="<?= $Page->hp->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_hp" name="x_hp" id="x_hp" size="30" maxlength="255" value="<?= $Page->hp->EditValue ?>"<?= $Page->hp->editAttributes() ?> aria-describedby="x_hp_help">
...
<?php if ($Page->md->Visible) { // md ?>
    <div id="r_md" class="form-group row">
        <label id="elh_pengasuhppwanita_md" for="x_md" class="<?= $Page->LeftColumnClass ?>"><?= $Page->md->caption() ?><?= $Page->md->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->md->cellAttributes() ?>>
<span id="el_pengasuhppwanita_md">
<input type="<?= $Page->md->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_md" name="x_md" id="x_md" size="30" maxlength="255" value="<?= $Page->md->EditValue ?>"<?= $Page->md->editAttributes() ?> aria-describedby="x_md_help">
...
<?php if ($Page->mts->Visible) { // mts ?>
    <div id="r_mts" class="form-group row">
        <label id="elh_pengasuhppwanita_mts" for="x_mts" class="<?= $Page->LeftColumnClass ?>"><?= $Page->mts->caption() ?><?= $Page->mts->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->mts->cellAttributes() ?>>
<span id="el_pengasuhppwanita_mts">
<input type="<?= $Page->mts->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_mts" name="x_mts" id="x_mts" size="30" maxlength="255" value="<?= $Page->mts->EditValue ?>"<?= $Page->mts->editAttributes() ?> aria-describedby="x_mts_help">
...
<?php if ($Page->ma->Visible) { // ma ?>
    <div id="r_ma" class="form-group row">
        <label id="elh_pengasuhppwanita_ma" for="x_ma" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ma->caption() ?><?= $Page->ma->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ma->cellAttributes() ?>>
<span id="el_pengasuhppwanita_ma">
<input type="<?= $Page->ma->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_ma" name="x_ma" id="x_ma" size="30" maxlength="255" value="<?= $Page->ma->EditValue ?>"<?= $Page->ma->editAttributes() ?> aria-describedby="x_ma_help">
...
<?php if ($Page->pesantren->Visible) { // pesantren ?>
    <div id="r_pesantren" class="form-group row">
        <label id="elh_pengasuhppwanita_pesantren" for="x_pesantren" class="<?= $Page->LeftColumnClass ?>"><?= $Page->pesantren->caption() ?><?= $Page->pesantren->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->pesantren->cellAttributes() ?>>
<span id="el_pengasuhppwanita_pesantren">
<input type="<?= $Page->pesantren->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_pesantren" name="x_pesantren" id="x_pesantren" size="30" maxlength="255" value="<?= $Page->pesantren->EditValue ?>"<?= $Page->pesantren->editAttributes() ?> aria-describedby="x_pesantren_help">
...
<?php if ($Page->s1->Visible) { // s1 ?>
    <div id="r_s1" class="form-group row">
        <label id="elh_pengasuhppwanita_s1" for="x_s1" class="<?= $Page->LeftColumnClass ?>"><?= $Page->s1->caption() ?><?= $Page->s1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->s1->cellAttributes() ?>>
<span id="el_pengasuhppwanita_s1">
<input type="<?= $Page->s1->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_s1" name="x_s1" id="x_s1" size="30" maxlength="255" value="<?= $Page->s1->EditValue ?>"<?= $Page->s1->editAttributes() ?> aria-describedby="x_s1_help">
...
<?php if ($Page->s2->Visible) { // s2 ?>
    <div id="r_s2" class="form-group row">
        <label id="elh_pengasuhppwanita_s2" for="x_s2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->s2->caption() ?><?= $Page->s2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->s2->cellAttributes() ?>>
<span id="el_pengasuhppwanita_s2">
<input type="<?= $Page->s2->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_s2" name="x_s2" id="x_s2" size="30" maxlength="255" value="<?= $Page->s2->EditValue ?>"<?= $Page->s2->editAttributes() ?> aria-describedby="x_s2_help">
...
<?php if ($Page->s3->Visible) { // s3 ?>
    <div id="r_s3" class="form-group row">
        <label id="elh_pengasuhppwanita_s3" for="x_s3" class="<?= $Page->LeftColumnClass ?>"><?= $Page->s3->caption() ?><?= $Page->s3->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->s3->cellAttributes() ?>>
<span id="el_pengasuhppwanita_s3">
<input type="<?= $Page->s3->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_s3" name="x_s3" id="x_s3" size="30" maxlength="255" value="<?= $Page->s3->EditValue ?>"<?= $Page->s3->editAttributes() ?> aria-describedby="x_s3_help">
...
<?php if ($Page->organisasi->Visible) { // organisasi ?>
    <div id="r_organisasi" class="form-group row">
        <label id="elh_pengasuhppwanita_organisasi" for="x_organisasi" class="<?= $Page->LeftColumnClass ?>"><?= $Page->organisasi->caption() ?><?= $Page->organisasi->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->organisasi->cellAttributes() ?>>
<span id="el_pengasuhppwanita_organisasi">
<input type="<?= $Page->organisasi->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_organisasi" name="x_organisasi" id="x_organisasi" size="30" maxlength="255" value="<?= $Page->organisasi->EditValue ?>"<?= $Page->organisasi->editAttributes() ?> aria-describedby="x_organisasi_help">
...
<?php if ($Page->jabatandiorganisasi->Visible) { // jabatandiorganisasi ?>
    <div id="r_jabatandiorganisasi" class="form-group row">
        <label id="elh_pengasuhppwanita_jabatandiorganisasi" for="x_jabatandiorganisasi" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jabatandiorganisasi->caption() ?><?= $Page->jabatandiorganisasi->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->jabatandiorganisasi->cellAttributes() ?>>
<span id="el_pengasuhppwanita_jabatandiorganisasi">
<input type="<?= $Page->jabatandiorganisasi->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_jabatandiorganisasi" name="x_jabatandiorganisasi" id="x_jabatandiorganisasi" size="30" maxlength="255" value="<?= $Page->jabatandiorganisasi->EditValue ?>"<?= $Page->jabatandiorganisasi->editAttributes() ?> aria-describedby="x_jabatandiorganisasi_help">
...
<?php if ($Page->tglawalorganisasi->Visible) { // tglawalorganisasi ?>
    <div id="r_tglawalorganisasi" class="form-group row">
        <label id="elh_pengasuhppwanita_tglawalorganisasi" for="x_tglawalorganisasi" class="<?= $Page->LeftColumnClass ?>"><?= $Page->tglawalorganisasi->caption() ?><?= $Page->tglawalorganisasi->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->tglawalorganisasi->cellAttributes() ?>>
<span id="el_pengasuhppwanita_tglawalorganisasi">
<input type="<?= $Page->tglawalorganisasi->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_tglawalorganisasi" data-format="7" name="x_tglawalorganisasi" id="x_tglawalorganisasi" value="<?= $Page->tglawalorganisasi->EditValue ?>"<?= $Page->tglawalorganisasi->editAttributes() ?> aria-describedby="x_tglawalorganisasi_help">
...
<script>
loadjs.ready(["fpengasuhppwanitaedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpengasuhppwanitaedit", "x_tglawalorganisasi", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->pemerintah->Visible) { // pemerintah ?>
    <div id="r_pemerintah" class="form-group row">
        <label id="elh_pengasuhppwanita_pemerintah" for="x_pemerintah" class="<?= $Page->LeftColumnClass ?>"><?= $Page->pemerintah->caption() ?><?= $Page->pemerintah->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->pemerintah->cellAttributes() ?>>
<span id="el_pengasuhppwanita_pemerintah">
<input type="<?= $Page->pemerintah->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_pemerintah" name="x_pemerintah" id="x_pemerintah" size="30" maxlength="255" value="<?= $Page->pemerintah->EditValue ?>"<?= $Page->pemerintah->editAttributes() ?> aria-describedby="x_pemerintah_help">
...
<?php if ($Page->jabatandipemerintah->Visible) { // jabatandipemerintah ?>
    <div id="r_jabatandipemerintah" class="form-group row">
        <label id="elh_pengasuhppwanita_jabatandipemerintah" for="x_jabatandipemerintah" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jabatandipemerintah->caption() ?><?= $Page->jabatandipemerintah->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->jabatandipemerintah->cellAttributes() ?>>
<span id="el_pengasuhppwanita_jabatandipemerintah">
<input type="<?= $Page->jabatandipemerintah->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_jabatandipemerintah" name="x_jabatandipemerintah" id="x_jabatandipemerintah" size="30" maxlength="255" value="<?= $Page->jabatandipemerintah->EditValue ?>"<?= $Page->jabatandipemerintah->editAttributes() ?> aria-describedby="x_jabatandipemerintah_help">
...
<?php if ($Page->tglmenjabat->Visible) { // tglmenjabat ?>
    <div id="r_tglmenjabat" class="form-group row">
        <label id="elh_pengasuhppwanita_tglmenjabat" for="x_tglmenjabat" class="<?= $Page->LeftColumnClass ?>"><?= $Page->tglmenjabat->caption() ?><?= $Page->tglmenjabat->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->tglmenjabat->cellAttributes() ?>>
<span id="el_pengasuhppwanita_tglmenjabat">
<input type="<?= $Page->tglmenjabat->getInputTextType() ?>" data-table="pengasuhppwanita" data-field="x_tglmenjabat" name="x_tglmenjabat" id="x_tglmenjabat" value="<?= $Page->tglmenjabat->EditValue ?>"<?= $Page->tglmenjabat->editAttributes() ?> aria-describedby="x_tglmenjabat_help">
...
<script>
loadjs.ready(["fpengasuhppwanitaedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpengasuhppwanitaedit", "x_tglmenjabat", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->foto->Visible) { // foto ?>
    <div id="r_foto" class="form-group row">
        <label id="elh_pengasuhppwanita_foto" class="<?= $Page->LeftColumnClass ?>"><?= $Page->foto->caption() ?><?= $Page->foto->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->foto->cellAttributes() ?>>
<span id="el_pengasuhppwanita_foto">
<div id="fd_x_foto">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->foto->title() ?>" data-table="pengasuhppwanita" data-field="x_foto" name="x_foto" id="x_foto" lang="<?= CurrentLanguageID() ?>" multiple<?= $Page->foto->editAttributes() ?><?= ($Page->foto->ReadOnly || $Page->foto->Disabled) ? " disabled" : "" ?> aria-describedby="x_foto_help">
...
<?php if ($Page->ijazah->Visible) { // ijazah ?>
    <div id="r_ijazah" class="form-group row">
        <label id="elh_pengasuhppwanita_ijazah" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ijazah->caption() ?><?= $Page->ijazah->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ijazah->cellAttributes() ?>>
<span id="el_pengasuhppwanita_ijazah">
<div id="fd_x_ijazah">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->ijazah->title() ?>" data-table="pengasuhppwanita" data-field="x_ijazah" name="x_ijazah" id="x_ijazah" lang="<?= CurrentLanguageID() ?>"<?= $Page->ijazah->editAttributes() ?><?= ($Page->ijazah->ReadOnly || $Page->ijazah->Disabled) ? " disabled" : "" ?> aria-describedby="x_ijazah_help">
...
<input type="hidden" name="fa_x_ijazah" id= "fa_x_ijazah" value="<?= (Post("fa_x_ijazah") == "0") ? "0" : "1" ?>">
...
<?php if ($Page->sertifikat->Visible) { // sertifikat ?>
    <div id="r_sertifikat" class="form-group row">
        <label id="elh_pengasuhppwanita_sertifikat" class="<?= $Page->LeftColumnClass ?>"><?= $Page->sertifikat->caption() ?><?= $Page->sertifikat->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->sertifikat->cellAttributes() ?>>
<span id="el_pengasuhppwanita_sertifikat">
<div id="fd_x_sertifikat">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->sertifikat->title() ?>" data-table="pengasuhppwanita" data-field="x_sertifikat" name="x_sertifikat" id="x_sertifikat" lang="<?= CurrentLanguageID() ?>"<?= $Page->sertifikat->editAttributes() ?><?= ($Page->sertifikat->ReadOnly || $Page->sertifikat->Disabled) ? " disabled" : "" ?> aria-describedby="x_sertifikat_help">
...
<input type="hidden" name="fa_x_sertifikat" id= "fa_x_sertifikat" value="<?= (Post("fa_x_sertifikat") == "0") ? "0" : "1" ?>">
