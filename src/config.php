...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'OifUo7ZzZmxZfsh6', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/nuportal.css", // Project stylesheet file name
    ...
    "BODY_CLASS" => "hold-transition layout-fixed accent-success",
    ...
    "USER_LEVEL_FIELD_NAME" => "grup",
    "USER_PROFILE_FIELD_NAME" => "",
    "REGISTER_ACTIVATE_FIELD_NAME" => "grup",
    ...
    // Email
    "SENDER_EMAIL" => "portalnu2021@gmail.com", // Sender email address
