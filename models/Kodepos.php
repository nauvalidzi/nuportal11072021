...
/**
 * Table class for kodepos
 */
class Kodepos extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'kodepos';
        $this->TableName = 'kodepos';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`kodepos`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`kodepos`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("KodeposList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "KodeposEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "KodeposAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("KodeposView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("KodeposView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "KodeposAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "KodeposAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("KodeposEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("KodeposAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("KodeposDelete", $this->getUrlParm());
    }
