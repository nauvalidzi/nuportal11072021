 ...
 * Page class
 */
class FasilitasusahaDelete extends Fasilitasusaha
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FasilitasusahaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FasilitasusahaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FasilitasusahaList"); // Return to list
                return;
            }
        }
