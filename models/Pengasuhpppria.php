...
/**
 * Table class for pengasuhpppria
 */
class Pengasuhpppria extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pengasuhpppria';
        $this->TableName = 'pengasuhpppria';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`pengasuhpppria`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // pid
        $this->pid = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, false, '`pid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama
        $this->nama = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, false, '`nama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->nama->Sortable = true; // Allow sort
        $this->nama->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->nama->Param, "CustomMsg");
        $this->Fields['nama'] = &$this->nama;

        // nik
        $this->nik = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_nik', 'nik', '`nik`', '`nik`', 200, 255, -1, false, '`nik`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // alamat
        $this->alamat = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 200, 255, -1, false, '`alamat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->alamat->Sortable = true; // Allow sort
        $this->alamat->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->alamat->Param, "CustomMsg");
        $this->Fields['alamat'] = &$this->alamat;

        // hp
        $this->hp = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_hp', 'hp', '`hp`', '`hp`', 200, 255, -1, false, '`hp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // md
        $this->md = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_md', 'md', '`md`', '`md`', 200, 255, -1, false, '`md`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mts
        $this->mts = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_mts', 'mts', '`mts`', '`mts`', 200, 255, -1, false, '`mts`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ma
        $this->ma = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_ma', 'ma', '`ma`', '`ma`', 200, 255, -1, false, '`ma`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pesantren
        $this->pesantren = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_pesantren', 'pesantren', '`pesantren`', '`pesantren`', 200, 255, -1, false, '`pesantren`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // s1
        $this->s1 = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_s1', 's1', '`s1`', '`s1`', 200, 255, -1, false, '`s1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // s2
        $this->s2 = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_s2', 's2', '`s2`', '`s2`', 200, 255, -1, false, '`s2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // s3
        $this->s3 = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_s3', 's3', '`s3`', '`s3`', 200, 255, -1, false, '`s3`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // organisasi
        $this->organisasi = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_organisasi', 'organisasi', '`organisasi`', '`organisasi`', 200, 255, -1, false, '`organisasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jabatandiorganisasi
        $this->jabatandiorganisasi = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_jabatandiorganisasi', 'jabatandiorganisasi', '`jabatandiorganisasi`', '`jabatandiorganisasi`', 200, 255, -1, false, '`jabatandiorganisasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tglawalorganisasi
        $this->tglawalorganisasi = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_tglawalorganisasi', 'tglawalorganisasi', '`tglawalorganisasi`', CastDateFieldForLike("`tglawalorganisasi`", 7, "DB"), 133, 10, 7, false, '`tglawalorganisasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tglakhirorganisasi
        $this->tglakhirorganisasi = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_tglakhirorganisasi', 'tglakhirorganisasi', '`tglakhirorganisasi`', CastDateFieldForLike("`tglakhirorganisasi`", 0, "DB"), 133, 10, 0, false, '`tglakhirorganisasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pemerintah
        $this->pemerintah = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_pemerintah', 'pemerintah', '`pemerintah`', '`pemerintah`', 200, 255, -1, false, '`pemerintah`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jabatandipemerintah
        $this->jabatandipemerintah = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_jabatandipemerintah', 'jabatandipemerintah', '`jabatandipemerintah`', '`jabatandipemerintah`', 200, 255, -1, false, '`jabatandipemerintah`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tglmenjabat
        $this->tglmenjabat = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_tglmenjabat', 'tglmenjabat', '`tglmenjabat`', CastDateFieldForLike("`tglmenjabat`", 7, "DB"), 133, 10, 7, false, '`tglmenjabat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tglmenjabat->Sortable = true; // Allow sort
        $this->tglmenjabat->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // tglakhirjabatan
        $this->tglakhirjabatan = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_tglakhirjabatan', 'tglakhirjabatan', '`tglakhirjabatan`', CastDateFieldForLike("`tglakhirjabatan`", 0, "DB"), 133, 10, 0, false, '`tglakhirjabatan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // foto
        $this->foto = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_foto', 'foto', '`foto`', '`foto`', 200, 255, -1, true, '`foto`', false, false, false, 'FORMATTED TEXT', 'FILE');
        ...
        // ijazah
        $this->ijazah = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_ijazah', 'ijazah', '`ijazah`', '`ijazah`', 200, 255, -1, true, '`ijazah`', false, false, false, 'FORMATTED TEXT', 'FILE');
        ...
        // sertifikat
        $this->sertifikat = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_sertifikat', 'sertifikat', '`sertifikat`', '`sertifikat`', 200, 255, -1, true, '`sertifikat`', false, false, false, 'FORMATTED TEXT', 'FILE');
        ...
        // dokumen
        $this->dokumen = new DbField('pengasuhpppria', 'pengasuhpppria', 'x_dokumen', 'dokumen', '`dokumen`', '`dokumen`', 200, 255, -1, true, '`dokumen`', false, false, false, 'FORMATTED TEXT', 'FILE');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`pengasuhpppria`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PengasuhpppriaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PengasuhpppriaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PengasuhpppriaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PengasuhpppriaView";
            case Config("API_ADD_ACTION"):
                return "PengasuhpppriaAdd";
            case Config("API_EDIT_ACTION"):
                return "PengasuhpppriaEdit";
            case Config("API_DELETE_ACTION"):
                return "PengasuhpppriaDelete";
            case Config("API_LIST_ACTION"):
                return "PengasuhpppriaList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PengasuhpppriaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PengasuhpppriaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PengasuhpppriaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PengasuhpppriaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PengasuhpppriaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PengasuhpppriaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PengasuhpppriaDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->tglmenjabat->EditValue = FormatDateTime($this->tglmenjabat->CurrentValue, 7);
