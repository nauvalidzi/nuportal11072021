 ...
 * Page class
 */
class KodeposList extends Kodepos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KodeposList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fkodeposlist";
    ...
    public function __construct()
    {
        ...
        // Table object (kodepos)
        if (!isset($GLOBALS["kodepos"]) || get_class($GLOBALS["kodepos"]) == PROJECT_NAMESPACE . "kodepos") {
            $GLOBALS["kodepos"] = &$this;
        }
        ...
        $this->AddUrl = "KodeposAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "KodeposDelete";
        $this->MultiUpdateUrl = "KodeposUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'kodepos');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fkodeposlistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("kodepos"));
                $doc->Text = @$content;
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fkodeposlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fkodeposlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fkodeposlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
