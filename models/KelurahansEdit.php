 ...
 * Page class
 */
class KelurahansEdit extends Kelurahans
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelurahansEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // kecamatan_id
            $this->kecamatan_id->setDbValueDef($rsnew, $this->kecamatan_id->CurrentValue, "", $this->kecamatan_id->ReadOnly);
