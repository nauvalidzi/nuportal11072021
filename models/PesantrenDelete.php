 ...
 * Page class
 */
class PesantrenDelete extends Pesantren
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PesantrenDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PesantrenList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("PesantrenList"); // Return to list
            return;
        }
