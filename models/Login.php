...
class Login extends User
{
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("user", "user", "username", "username", "username", "", 202, 255, 0, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-control");
        $this->Password = new DbField("user", "user", "password", "password", "password", "", 202, 255, 0, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("user", "user", "type", "logintype", "logintype", "", 202, 255, 0, false, "", false, false, false);
    ...
    {
        // Example:
        $header = "<br><br><br><br><br><br><br><center></center>";
    }
