 ...
 * Page class
 */
class PendidikanpesantrenView extends Pendidikanpesantren
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendidikanpesantrenView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PendidikanpesantrenList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PendidikanpesantrenList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PendidikanpesantrenList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
