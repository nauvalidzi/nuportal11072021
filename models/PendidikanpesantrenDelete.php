 ...
 * Page class
 */
class PendidikanpesantrenDelete extends Pendidikanpesantren
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendidikanpesantrenDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PendidikanpesantrenList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PendidikanpesantrenList"); // Return to list
                return;
            }
        }
