 ...
 * Page class
 */
class PendidikanpesantrenPreview extends Pendidikanpesantren
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendidikanpesantrenPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "jenispendidikanpesantren") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=jenispendidikanpesantren&" . GetForeignKeyUrl("fk_id", $this->idjenispp->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "jenispendidikanpesantren") {
            ...
            if ($x !== false) {
                ...
                $val = substr($f, $x);
                $val = $this->unquoteValue($val, "DB");
                 $this->idjenispp->setQueryStringValue($val);
            }
        }
    }
