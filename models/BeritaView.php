 ...
 * Page class
 */
class BeritaView extends Berita
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "BeritaList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BeritaList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "BeritaList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
