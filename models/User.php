...
class User extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('user', 'user', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // namapesantren
        $this->namapesantren = new DbField('user', 'user', 'x_namapesantren', 'namapesantren', '`namapesantren`', '`namapesantren`', 200, 255, -1, false, '`namapesantren`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->namapesantren->Required = true; // Required field
        $this->namapesantren->Sortable = true; // Allow sort
        $this->namapesantren->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->namapesantren->Param, "CustomMsg");
        $this->Fields['namapesantren'] = &$this->namapesantren;

        // namapendaftar
        $this->namapendaftar = new DbField('user', 'user', 'x_namapendaftar', 'namapendaftar', '`namapendaftar`', '`namapendaftar`', 200, 255, -1, false, '`namapendaftar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->namapendaftar->Sortable = true; // Allow sort
        $this->namapendaftar->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->namapendaftar->Param, "CustomMsg");
        $this->Fields['namapendaftar'] = &$this->namapendaftar;

        // hp
        $this->hp = new DbField('user', 'user', 'x_hp', 'hp', '`hp`', '`hp`', 200, 255, -1, false, '`hp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // username
        $this->_username = new DbField('user', 'user', 'x__username', 'username', '`username`', '`username`', 200, 20, -1, false, '`username`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // passsword
        $this->passsword = new DbField('user', 'user', 'x_passsword', 'passsword', '`passsword`', '`passsword`', 200, 20, -1, false, '`passsword`', false, false, false, 'FORMATTED TEXT', 'PASSWORD');
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->passsword->Raw = true;
        }
        $this->passsword->Required = true; // Required field
        $this->passsword->Sortable = true; // Allow sort
        $this->passsword->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->passsword->Param, "CustomMsg");
        $this->Fields['passsword'] = &$this->passsword;

        // grup
        $this->grup = new DbField('user', 'user', 'x_grup', 'grup', '`grup`', '`grup`', 3, 11, -1, false, '`grup`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->grup->Sortable = true; // Allow sort
        $this->grup->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->grup->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->grup->Lookup = new Lookup('grup', 'userlevels', false, 'userlevelid', ["userlevelname","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->grup->Lookup = new Lookup('grup', 'userlevels', false, 'userlevelid', ["userlevelname","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->grup->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "wilayah") {
            $detailUrl = Container("wilayah")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->namapesantren->DbValue = $row['namapesantren'];
        $this->namapendaftar->DbValue = $row['namapendaftar'];
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("UserEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("UserAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->namapesantren->EditValue = $this->namapesantren->CurrentValue;
        ...
        $this->namapendaftar->EditValue = $this->namapendaftar->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->namapesantren);
                    $doc->exportCaption($this->namapendaftar);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->namapesantren);
                        $doc->exportField($this->namapendaftar);
