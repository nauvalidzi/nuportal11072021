 ...
 * Page class
 */
class FasilitaspesantrenPreview extends Fasilitaspesantren
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FasilitaspesantrenPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pesantren") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pesantren&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
