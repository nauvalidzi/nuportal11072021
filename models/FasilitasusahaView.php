 ...
 * Page class
 */
class FasilitasusahaView extends Fasilitasusaha
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FasilitasusahaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FasilitasusahaList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "FasilitasusahaList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "FasilitasusahaList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function newRow()
    {
        ...
        $row['aset'] = null;
        $row['modal'] = null;
        $row['hasilsetahun'] = null;
        $row['kendala'] = null;
        $row['fasilitasperlu'] = null;
        $row['foto'] = null;
        $row['dokumen'] = null;
        return $row;
    }
