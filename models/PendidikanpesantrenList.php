 ...
 * Page class
 */
class PendidikanpesantrenList extends Pendidikanpesantren
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendidikanpesantrenList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpendidikanpesantrenlist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "PendidikanpesantrenDelete";
        $this->MultiUpdateUrl = "PendidikanpesantrenUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpendidikanpesantrenlistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->idjenispp->AdvancedSearch->toJson(), ","); // Field idjenispp
        ...
        $filterList = Concat($filterList, $this->tglberdiri->AdvancedSearch->toJson(), ","); // Field tglberdiri
        $filterList = Concat($filterList, $this->ijinakhir->AdvancedSearch->toJson(), ","); // Field ijinakhir
        $filterList = Concat($filterList, $this->jumlahpengajar->AdvancedSearch->toJson(), ","); // Field jumlahpengajar
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpendidikanpesantrenlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field idjenispp
        $this->idjenispp->AdvancedSearch->SearchValue = @$filter["x_idjenispp"];
        $this->idjenispp->AdvancedSearch->SearchOperator = @$filter["z_idjenispp"];
        $this->idjenispp->AdvancedSearch->SearchCondition = @$filter["v_idjenispp"];
        $this->idjenispp->AdvancedSearch->SearchValue2 = @$filter["y_idjenispp"];
        $this->idjenispp->AdvancedSearch->SearchOperator2 = @$filter["w_idjenispp"];
        $this->idjenispp->AdvancedSearch->save();
        ...
        // Field tglberdiri
        $this->tglberdiri->AdvancedSearch->SearchValue = @$filter["x_tglberdiri"];
        $this->tglberdiri->AdvancedSearch->SearchOperator = @$filter["z_tglberdiri"];
        $this->tglberdiri->AdvancedSearch->SearchCondition = @$filter["v_tglberdiri"];
        $this->tglberdiri->AdvancedSearch->SearchValue2 = @$filter["y_tglberdiri"];
        $this->tglberdiri->AdvancedSearch->SearchOperator2 = @$filter["w_tglberdiri"];
        $this->tglberdiri->AdvancedSearch->save();

        // Field ijinakhir
        $this->ijinakhir->AdvancedSearch->SearchValue = @$filter["x_ijinakhir"];
        $this->ijinakhir->AdvancedSearch->SearchOperator = @$filter["z_ijinakhir"];
        $this->ijinakhir->AdvancedSearch->SearchCondition = @$filter["v_ijinakhir"];
        $this->ijinakhir->AdvancedSearch->SearchValue2 = @$filter["y_ijinakhir"];
        $this->ijinakhir->AdvancedSearch->SearchOperator2 = @$filter["w_ijinakhir"];
        $this->ijinakhir->AdvancedSearch->save();

        // Field jumlahpengajar
        $this->jumlahpengajar->AdvancedSearch->SearchValue = @$filter["x_jumlahpengajar"];
        $this->jumlahpengajar->AdvancedSearch->SearchOperator = @$filter["z_jumlahpengajar"];
        $this->jumlahpengajar->AdvancedSearch->SearchCondition = @$filter["v_jumlahpengajar"];
        $this->jumlahpengajar->AdvancedSearch->SearchValue2 = @$filter["y_jumlahpengajar"];
        $this->jumlahpengajar->AdvancedSearch->SearchOperator2 = @$filter["w_jumlahpengajar"];
        $this->jumlahpengajar->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->ijin, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->jumlahpengajar, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->idjenispp); // idjenispp
            $this->updateSort($this->nama); // nama
            $this->updateSort($this->ijin); // ijin
            $this->updateSort($this->tglberdiri); // tglberdiri
            $this->updateSort($this->ijinakhir); // ijinakhir
            $this->updateSort($this->jumlahpengajar); // jumlahpengajar
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id->setSort("");
                $this->pid->setSort("");
                $this->idjenispp->setSort("");
                $this->nama->setSort("");
                $this->ijin->setSort("");
                $this->tglberdiri->setSort("");
                $this->ijinakhir->setSort("");
                $this->jumlahpengajar->setSort("");
                $this->foto->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpendidikanpesantrenlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpendidikanpesantrenlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpendidikanpesantrenlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpendidikanpesantrenlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
