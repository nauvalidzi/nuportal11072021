 ...
 * Page class
 */
class PendidikanumumView extends Pendidikanumum
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendidikanumumView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PendidikanumumList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PendidikanumumList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PendidikanumumList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
