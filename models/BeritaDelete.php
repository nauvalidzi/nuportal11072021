 ...
 * Page class
 */
class BeritaDelete extends Berita
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BeritaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BeritaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BeritaList"); // Return to list
                return;
            }
        }
