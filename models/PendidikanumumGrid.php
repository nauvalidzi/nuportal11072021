 ...
 * Page class
 */
class PendidikanumumGrid extends Pendidikanumum
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendidikanumumGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpendidikanumumgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_idjenispu") && $CurrentForm->hasValue("o_idjenispu") && $this->idjenispu->CurrentValue != $this->idjenispu->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->idjenispu->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_idjenispu")) {
            $this->idjenispu->setOldValue($CurrentForm->getValue("o_idjenispu"));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // idjenispu
            $this->idjenispu->setDbValueDef($rsnew, $this->idjenispu->CurrentValue, null, $this->idjenispu->ReadOnly);
