 ...
 * Page class
 */
class PendidikanumumDelete extends Pendidikanumum
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendidikanumumDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PendidikanumumList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PendidikanumumList"); // Return to list
                return;
            }
        }
