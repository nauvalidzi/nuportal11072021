...
class UserEdit extends User
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->passsword->EditValue = $Language->phrase("PasswordMask"); // Show as masked password
    ...
    protected function validateForm()
    {
        ...
        if (in_array("wilayah", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // namapesantren
            $this->namapesantren->setDbValueDef($rsnew, $this->namapesantren->CurrentValue, null, $this->namapesantren->ReadOnly);

            // namapendaftar
            $this->namapendaftar->setDbValueDef($rsnew, $this->namapendaftar->CurrentValue, null, $this->namapendaftar->ReadOnly);
            ...
            if (!IsMaskedPassword($this->passsword->CurrentValue)) {
                $this->passsword->setDbValueDef($rsnew, $this->passsword->CurrentValue, null, $this->passsword->ReadOnly || Config("ENCRYPTED_PASSWORD") && $rsold['passsword'] == $this->passsword->CurrentValue);
            }
