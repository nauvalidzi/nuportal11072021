 ...
 * Page class
 */
class KodeposView extends Kodepos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KodeposView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "KodeposList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "KodeposList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "KodeposList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
