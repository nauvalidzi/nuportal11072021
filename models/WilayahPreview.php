 ...
 * Page class
 */
class WilayahPreview extends Wilayah
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WilayahPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "user") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=user&" . GetForeignKeyUrl("fk_id", $this->iduser->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "user") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->iduser->setQueryStringValue($val);
            }
        }
    }
