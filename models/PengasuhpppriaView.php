 ...
 * Page class
 */
class PengasuhpppriaView extends Pengasuhpppria
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengasuhpppriaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PengasuhpppriaList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PengasuhpppriaList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PengasuhpppriaList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
