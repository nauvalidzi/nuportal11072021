 ...
 * Page class
 */
class KodeposEdit extends Kodepos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KodeposEdit";
    ...
    protected function validateForm()
    {
        ...
        if ($this->kelurahan_id->Required) {
            if (!$this->kelurahan_id->IsDetailKey && EmptyValue($this->kelurahan_id->FormValue)) {
                $this->kelurahan_id->addErrorMessage(str_replace("%s", $this->kelurahan_id->caption(), $this->kelurahan_id->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->kelurahan_id->FormValue)) {
            $this->kelurahan_id->addErrorMessage($this->kelurahan_id->getErrorMessage(false));
        }
