 ...
 * Page class
 */
class PengasuhppwanitaDelete extends Pengasuhppwanita
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengasuhppwanitaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PengasuhppwanitaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PengasuhppwanitaList"); // Return to list
                return;
            }
        }
