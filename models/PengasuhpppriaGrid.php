 ...
 * Page class
 */
class PengasuhpppriaGrid extends Pengasuhpppria
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengasuhpppriaGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpengasuhpppriagrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_md") && $CurrentForm->hasValue("o_md") && $this->md->CurrentValue != $this->md->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_mts") && $CurrentForm->hasValue("o_mts") && $this->mts->CurrentValue != $this->mts->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_ma") && $CurrentForm->hasValue("o_ma") && $this->ma->CurrentValue != $this->ma->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_pesantren") && $CurrentForm->hasValue("o_pesantren") && $this->pesantren->CurrentValue != $this->pesantren->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_s1") && $CurrentForm->hasValue("o_s1") && $this->s1->CurrentValue != $this->s1->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_s2") && $CurrentForm->hasValue("o_s2") && $this->s2->CurrentValue != $this->s2->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_s3") && $CurrentForm->hasValue("o_s3") && $this->s3->CurrentValue != $this->s3->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_organisasi") && $CurrentForm->hasValue("o_organisasi") && $this->organisasi->CurrentValue != $this->organisasi->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_jabatandiorganisasi") && $CurrentForm->hasValue("o_jabatandiorganisasi") && $this->jabatandiorganisasi->CurrentValue != $this->jabatandiorganisasi->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_tglawalorganisasi") && $CurrentForm->hasValue("o_tglawalorganisasi") && $this->tglawalorganisasi->CurrentValue != $this->tglawalorganisasi->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_pemerintah") && $CurrentForm->hasValue("o_pemerintah") && $this->pemerintah->CurrentValue != $this->pemerintah->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_jabatandipemerintah") && $CurrentForm->hasValue("o_jabatandipemerintah") && $this->jabatandipemerintah->CurrentValue != $this->jabatandipemerintah->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_tglmenjabat") && $CurrentForm->hasValue("o_tglmenjabat") && $this->tglmenjabat->CurrentValue != $this->tglmenjabat->OldValue) {
            return false;
        }
        if (!EmptyValue($this->foto->Upload->Value)) {
            return false;
        }
        if (!EmptyValue($this->ijazah->Upload->Value)) {
            return false;
        }
        if (!EmptyValue($this->sertifikat->Upload->Value)) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->md->clearErrorMessage();
        $this->mts->clearErrorMessage();
        $this->ma->clearErrorMessage();
        $this->pesantren->clearErrorMessage();
        $this->s1->clearErrorMessage();
        $this->s2->clearErrorMessage();
        $this->s3->clearErrorMessage();
        $this->organisasi->clearErrorMessage();
        $this->jabatandiorganisasi->clearErrorMessage();
        $this->tglawalorganisasi->clearErrorMessage();
        $this->pemerintah->clearErrorMessage();
        $this->jabatandipemerintah->clearErrorMessage();
        $this->tglmenjabat->clearErrorMessage();
        $this->foto->clearErrorMessage();
        $this->ijazah->clearErrorMessage();
        $this->sertifikat->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_md")) {
            $this->md->setOldValue($CurrentForm->getValue("o_md"));
        }
        ...
        if ($CurrentForm->hasValue("o_mts")) {
            $this->mts->setOldValue($CurrentForm->getValue("o_mts"));
        }
        ...
        if ($CurrentForm->hasValue("o_ma")) {
            $this->ma->setOldValue($CurrentForm->getValue("o_ma"));
        }
        ...
        if ($CurrentForm->hasValue("o_pesantren")) {
            $this->pesantren->setOldValue($CurrentForm->getValue("o_pesantren"));
        }
        ...
        if ($CurrentForm->hasValue("o_s1")) {
            $this->s1->setOldValue($CurrentForm->getValue("o_s1"));
        }
        ...
        if ($CurrentForm->hasValue("o_s2")) {
            $this->s2->setOldValue($CurrentForm->getValue("o_s2"));
        }
        ...
        if ($CurrentForm->hasValue("o_s3")) {
            $this->s3->setOldValue($CurrentForm->getValue("o_s3"));
        }
        ...
        if ($CurrentForm->hasValue("o_organisasi")) {
            $this->organisasi->setOldValue($CurrentForm->getValue("o_organisasi"));
        }
        ...
        if ($CurrentForm->hasValue("o_jabatandiorganisasi")) {
            $this->jabatandiorganisasi->setOldValue($CurrentForm->getValue("o_jabatandiorganisasi"));
        }
        ...
        if ($CurrentForm->hasValue("o_tglawalorganisasi")) {
            $this->tglawalorganisasi->setOldValue($CurrentForm->getValue("o_tglawalorganisasi"));
        }
        ...
        if ($CurrentForm->hasValue("o_pemerintah")) {
            $this->pemerintah->setOldValue($CurrentForm->getValue("o_pemerintah"));
        }
        ...
        if ($CurrentForm->hasValue("o_jabatandipemerintah")) {
            $this->jabatandipemerintah->setOldValue($CurrentForm->getValue("o_jabatandipemerintah"));
        }
        ...
        if ($CurrentForm->hasValue("o_tglmenjabat")) {
            $this->tglmenjabat->setOldValue($CurrentForm->getValue("o_tglmenjabat"));
        }
