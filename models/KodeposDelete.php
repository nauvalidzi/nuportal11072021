 ...
 * Page class
 */
class KodeposDelete extends Kodepos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KodeposDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("KodeposList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("KodeposList"); // Return to list
                return;
            }
        }
